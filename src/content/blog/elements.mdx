...
<Alert variant="info">This is a simple note.</Alert>

<Alert variant="success">This is a simple note.</Alert>

<Alert variant="info">This is a simple note.</Alert>

<Alert variant="warning">This is a simple note.</Alert>
...
<Tabs>
  <TabsList>
    <TabsTab panel="tab1" active>Tab 1</TabsTab>
    <TabsTab panel="tab2">Tab 2</TabsTab>
    <TabsTab panel="tab3">Tab 3</TabsTab>
  </TabsList>
  <TabsPanel id="tab1" active>
